* In this project when we want to login to the application we need to enter the correct "Email address" and "password" both email address and password are mandatory. 
